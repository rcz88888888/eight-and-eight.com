...
const updateParallax = () => {
  ...
  // The document-high image naturally moves at 100%. Counteract 99.99%,
  // leaving the small-logo layer moving upward at only 0.01%.
  document.documentElement.style.setProperty("--background-counter-shift", `${(scrollY * 0.9999).toFixed(2)}px`);
